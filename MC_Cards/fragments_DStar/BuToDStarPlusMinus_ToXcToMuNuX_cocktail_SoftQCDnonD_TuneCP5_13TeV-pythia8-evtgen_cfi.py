...
Decay MyB+
  ...
  0.0005   MyD+         MyD*-            K*+      PHSP;
  0.0010   MyD*+        MyOtherD*-       K*+      PHSP;
  0.00039  MyD*+        MyOtheranti-D0            SVS;
  0.00045  MyD'_s1+     MyOtheranti-D0            PHSP;
  0.00094  MyD'_s1+     Myanti-D*0                PHSP;
  0.00081  MyD*+        Myanti-D*0                SVV_HELAMP 0.48 0.0 0.734 0.0 0.48 0.0;
  0.0078   MyD*+        Myanti-D*0       K0       PHSP;
  0.0005   MyD*+        MyD-  K+                  PHSP;
  0.0005   MyD*-        MyD+  K+                  PHSP;
  0.0015   MyD*+        MyOtherD*-       K+       PHSP;
Enddecay
CDecay MyB-
#
Decay MyD*-
