...
#
Decay MyB0s
  1.000    MyJpsi      MyPhi             PVV_CPLH 0.02 1 Hp pHp Hz pHz Hm pHm;
Enddecay
CDecay Myanti-B0s
#
Decay MyJpsi
...
decayfilter = cms.EDFilter(
    ...
    ParticleID      = cms.untracked.int32(531),  ## Bs
    DaughterIDs     = cms.untracked.vint32(443, 333), ## J/psi and phi
...
probefilter=cms.EDFilter("PythiaProbeFilter",  # bachelor muon with kinematic cuts.
    ...
    AuntIDs=cms.untracked.vint32(333),
)


ProductionFilterSequence = cms.Sequence(generator*bfilter*decayfilter*phifilter*jpsifilter*mu3filter*probefilter)
