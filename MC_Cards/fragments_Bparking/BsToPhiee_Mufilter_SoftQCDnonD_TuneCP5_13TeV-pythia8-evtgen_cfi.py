...
#
Decay MyB0s
  1.000        MyPhi     e+     e-               PHOTOS BTOSLLBALL 6;
Enddecay
Decay Myanti-B0s
  1.000        MyPhi     e+     e-            PHOTOS BTOSLLBALL 6;
Enddecay
...
decayfilter = cms.EDFilter("PythiaDauVFilter",
    DaughterIDs = cms.untracked.vint32(-11, 11, 333),
...
ProductionFilterSequence = cms.Sequence(generator*bfilter*decayfilter*phifilter*mufilter)
